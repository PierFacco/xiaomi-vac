...
IJAI_CORE_STD = CoreCapability(
    ...
    stop=Action(2, 2),
    charge=Action(3, 1),
    status_map={0: 'idle', 1: 'idle', 2: 'paused', 3: 'returning', 4: 'docked', 5: 'cleaning', 6: 'cleaning', 7: 'cleaning', 8: 'error', 9: 'docked', 10: 'docked'},
    status_labels={0: 'sleep', 1: 'idle', 2: 'paused', 3: 'returning', 4: 'charging', 5: 'cleaning', 6: 'cleaning', 7: 'mopping', 8: 'upgrading', 9: 'mop_cleaning', 10: 'mop_air_drying'},
